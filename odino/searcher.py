...
class SearchResult:
    ...
    def __init__(self, file_path: str, content: str, score: float, 
                 start_line: int, end_line: int, metadata: Dict):
...
class Searcher:
    ...
    def __init__(self, project_root: Path, console: Optional[Console] = None):
        ...
        try:
            ...
            self.console.print(f"[red]Error: Collection not found. Please run 'odino index' first.[/red]")
            raise
    ...
    def search(self, query: str, top_k: Optional[int] = None, include_pattern: Optional[str] = None, exclude_pattern: Optional[str] = None) -> List[SearchResult]:
    ...
    def format_results(self, results: List[SearchResult], query: str) -> None:
        ...
        for i, result in enumerate(results, 1):
            ...
            header += f" [bold {score_color}](score: {result.score:.3f})[/bold {score_color}]"
    ...
    def search_with_filter(self, query: str, include_pattern: Optional[str] = None, 
